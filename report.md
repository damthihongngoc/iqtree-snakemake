...
## 2. Pipeline IQ-TREE trong Snakemake
...
### 3.2. Cấu hình chuẩn cho bioinformatics
Chạy lần lượt
...
## 5. Khái niệm quan trọng trong Snakemake
...
## 6. Giải thích pipeline IQ-TREE từng bước

### STEP 2 – Basic ML tree

* Input: alignment `.fa`
* Phân tích: ModelFinder + ML + Ultrafast Bootstrap
...
* Phục vụ phân tích gene ảnh hưởng mạnh
